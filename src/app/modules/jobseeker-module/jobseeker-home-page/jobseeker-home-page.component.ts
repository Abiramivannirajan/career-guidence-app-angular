...
export class JobSeekerHomePageComponent {
  ...
  features = [
    ...
    { title: "Mock-interviews", description: "Prepare for your next big interview with tips, mock interviews, and expert advice.", button: "More-info", route: "/mock-interviews" },
